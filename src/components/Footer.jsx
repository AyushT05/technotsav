function Footer() {
  return (
    <footer>
      ...
      <div className="footer-title">TECHNOTSAV</div>

      <div className="footer-sub">
        &gt; 24HR HACKATHON · APRIL 15–16, 2025_
      </div>
      ...
      <div className="footer-logos">
        <div className="ieee-badge">⬡ IEEE</div>
        <div className="ieee-badge">
          IEEE Computational Intelligence Society
        </div>
        <div className="ieee-badge">VTU Affiliated</div>
      </div>

      <div className="footer-bottom">
        © 2025 TECHNOTSAV · VVCE · All rights reserved
      </div>
